        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <form action="orders-show.php">
                        <div class="row">
                            <img class="img-fluid" style="display: inline !important; width: 100px;" src="https://1000logos.net/wp-content/uploads/2021/11/VISA-logo.png" width="100" alt="">
                            <img class="img-fluid" style="display: inline !important; width: 100px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/MasterCard_Logo.svg/2560px-MasterCard_Logo.svg.png" width="100" alt="">
                        </div>

                        <div class="row mt-3">
                            <div style="text-align: left;">
                                <label for="title" class="col-form-label">Card Owner Name *</label>
                        ...
                        <div class="row">
                            <div style="text-align: left;">
                                <label for="title" class="col-form-label">Card Number *</label>
                                <input type="text" pattern="[0-9]{16}" class="form-control" id="title" maxlength="16">
                                <!-- <span class="text-danger" style="font-weight: bold;">* error</span> -->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="row">
                                    <label for="title" class="col-form-label" style="text-align: left;">Expire Date *</label>
                                    <div class="col-6">
                                        <div style="text-align: left;">
                                            <input type="text" pattern="[0-9]{2}" placeholder="mm" class="form-control" id="title" maxlength="2">
                                            <!-- <span class="text-danger" style="font-weight: bold;">* error</span> -->
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div style="text-align: left;">
                                            <input type="text" pattern="[0-9]{2}" placeholder="yy" class="form-control" id="title" maxlength="2">
                                            <!-- <span class="text-danger" style="font-weight: bold;">* error</span> -->
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-6">
                                <div style="text-align: left;">
                                    <label for="title" class="col-form-label">CVV *</label>
                                    <input type="text" pattern="[0-9]{3}" class="form-control" id="title" maxlength="3">
                                    <!-- <span class="text-danger" style="font-weight: bold;">* error</span> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-3" style="text-align: left;">
                            <!-- <button type="submit" class="btn btn-primary" onclick="return confirm('Are You Sure You Want To Continue?')">Purchase &nbsp; <i class="bi bi-cash"></i></button> -->
                            <a href="orders-save.php?<?= Request::queryString() ?>" class="btn btn-primary" onclick="return confirm('Are You Sure You Want To Continue?')">Purchase &nbsp; <i class="bi bi-cash"></i></a>
                        </div>
                    </form>
                </div>
            </div>
