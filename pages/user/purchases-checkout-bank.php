            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <form action="" class="form">
                        <label for="" class="fw-bold">Farmer Bank Account</label>
                        <div class="row justify-content-around my-4">
                            <div class="col-5 card p-0">
                                <div class="card-header">
                                    Faisal King Bank Account
                                </div>
                                <div class="card-header">
                                    218789415687
                                </div>
                        ...
                        <div class="text-end mb-5">
                            <label for="" class="fw-bold">Select Bill Image *</label>
                            <input type="file" class="form-control mt-2" name="file" required>
                        </div>

                        <div class="mt-3 text-center" style="text-align: left;">
