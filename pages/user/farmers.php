        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">Farmers</h1>
                    <hr class="divider" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5"><a href="index.php" class="white-link">Home</a> / Farmers</p>
                    ...
                    <div class="col-lg-4 mt-3">
                        <div class="card">
                            <img src="<?= '../../assets/uploads/' . $farmer->image ?>"
                                class="card-img-top rounded-circle p-3 mx-auto"
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><?= ucwords($farmer->location ?? 'Riyadh') ?></p>
                            </div>
                            <div class="card-body">
                                <div>
                                    <small class="d-block"><b class="text-primary">Commercial Registry Number:</b> <?= $farmer->commercial_number ?></small>
                                    <small class="d-block"><b class="text-primary">Rating:</b> <span class="my-rating-read-only" data-rating="<?= $farmer->getRating() ?>" dir="ltr"></span></small>
                                </div>
                            </div>
                            <div class="card-footer">
                                <a class="btn btn-primary"
                                    href="chat-details.php?other_id=<?= $farmer->id ?>">
                                    Chat <i class="bi bi-chat"></i>
                                </a>
                                <a class="btn btn-primary"
                                    href="farmers-show.php?id=<?= $farmer->id ?>">
                                    Show Details <i class="bi bi-person"></i>
                                </a>
                            </div>
                        </div>
                    </div>
