<?php
     ...
     * @var Product[]
     */
    $vegetables = Product::getVegetables();
?>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">Vegetables</h1>
                    <hr class="divider" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5"><a href="index.php" class="white-link">Home</a> / Products / Vegetables</p>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <?php foreach ($vegetables as $vegetable): ?>
                    <?php
                        $farmer = $vegetable->getFarmer();
                    ?>
                    <div class="col-lg-4 mt-3">
                        <div class="card h-100">
                            <img src="<?= '../../assets/uploads/' . $vegetable->image ?>" onerror="this.src = 'https://ajsrp.com/wp-content/uploads/2022/10/placeholder.png'" class="card-img-top" alt="..."
                                style="height: 300px; object-fit: cover;">
                            <div class="card-body">
                                <h5 class="card-title"><?= $vegetable->name ?></h5>
                                <p class="card-text"><?= $vegetable->desc ?></p>
                            </div>
                            <div class="card-body">
                                <div>
                                    <small class="d-block"><b class="text-primary">Remaining Quantity:</b> <?= $vegetable->quantity ?></small>
                                    <small class="d-block"><b class="text-primary">Price:</b> <?= $vegetable->price ?> SAR</small>
                                </div>
                                <hr>
                                <div>
                                    <small class="d-block"><b class="text-primary">Farmer's Name:</b> <?= $farmer->name ?></small>
                            ...
                            <div class="card-footer">
                                <form action="products-vegetables.php" method="POST">
