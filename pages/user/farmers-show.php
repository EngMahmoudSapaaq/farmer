<?php
    ...
    if (Request::has('id')) {
        $farmer_id = Request::get('id');
        $farmer = Farmer::query()->find($farmer_id);
        if (!$farmer)
            Redirect::withError('farmers.php', 'This farmer does not exists!');
    } else {
        Redirect::withError('farmers.php', 'This farmer does not exists!');
    }
?>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">Farmer's Data</h1>
                    <hr class="divider" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5"><a href="index.php" class="white-link">Home</a> / <a href="farmers.php" class="white-link">Farmers</a> / Data</p>
